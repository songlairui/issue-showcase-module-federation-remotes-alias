...
// @ts-ignore
import RemoteByAlias from "module-federation-vite-react-remote/src/App";
// @ts-ignore
...
export default () => {
	...
	return (
		<>
			...
			<RemoteByAlias title="I'm directly imported by monorrepo alias" />
			...
			<div>
				<p>{`RemoteByAlias === Remote`}</p>
				<span>{RemoteByAlias === Remote ? "true" : "false"}</span>
			</div>
		</>
	);
};
